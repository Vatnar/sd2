...
internal vk::CommandBuffer begin_single_time_command(vk::Device      vk_device,
...
internal U32                find_memory_type(vk::PhysicalDevice      vk_phys_dev,
                                             U32                     type_filter,
...
internal void copy_buffer_to_image(vk::CommandBuffer command_buffer,
                                   vk::Buffer        buffer,
                                   vk::Image         image,
                                   U32               width,
                                   U32               height);
